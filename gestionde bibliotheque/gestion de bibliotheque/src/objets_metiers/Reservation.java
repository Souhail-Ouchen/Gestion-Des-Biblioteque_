...
//                + " AND ";
    ...
    public void reserver(Usager usager, Oeuvre oeuvre, Date dateJour) throws ErrorException {
        Reservation reservation = findByReservation(usager, oeuvre);
        if (null != reservation) {
            throw new ErrorException("Vous avez déjà réservé l'oeuvre '" + oeuvre.getTitre()
        ...
        try {
            ...
            if (statut == 0) {
                throw new ErrorException("Echec lors de l'enregistrement de la réservation");
            }
        } catch (SQLException e) {
            throw new ErrorException("Erreurs lors de l'enregistrement de la réservation", e.getCause());
    ...
    public void annuler(Usager usager, Oeuvre oeuvre, Reservation reservation) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de l'annulation de la réservation");
            }
        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de  l'annulation de la réservation", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public Reservation findById(int id) throws ErrorException {
    ...
    public ArrayList<Reservation> findByDateReservaton(Date dateRes) throws ErrorException {
    ...
    public Reservation findByReservation(Usager usager, Oeuvre oeuvre) throws ErrorException {
    ...
    public ArrayList<Reservation> findByReservation(Oeuvre oeuvre) throws ErrorException {
    ...
    private ArrayList<Reservation> find(String sql, Object... objets) throws ErrorException {
        PreparedStatement preparedStatement = null;
