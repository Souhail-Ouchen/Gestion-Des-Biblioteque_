...
public class Oeuvre {
    ...
    private boolean oeuvreExiste(Oeuvre oeuvre) throws ErrorException {
    ...
    public void ajouter(Oeuvre oeuvre) throws ErrorException {

        if (oeuvreExiste(oeuvre)) {
            throw new ErrorException("Cette oeuvre est déjà ajoutée");
        }
        ...
        try {
            ...
            if (statut == 0) {
                throw new ErrorException("Echec d'ajout de l'oeuvre");
            }

        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de l'ajout de l'oeuvre", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Oeuvre oeuvre) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de la mise à jour de l'oeuvre");
            }
        } catch (SQLException e) {
            throw new ErrorException("Erreurs lors de la mise à jour de l'oeuvre ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
     ...
     */
    public ArrayList<Oeuvre> getListOeuvres() throws ErrorException {
     ...
     * @throws ErrorException
     */
    public Oeuvre findById(int id) throws ErrorException {
...
//        return oeuvres.isEmpty() ? null : oeuvres.get(0);
//    }
    public ArrayList<Oeuvre> findByTitre(String titre) throws ErrorException {
    ...
    private ArrayList<Oeuvre> find(String sql, Object... objets) throws ErrorException {
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            throw new ErrorException("Aucune oeuvre trouvée " + e.getMessage());
        } finally {
    ...
    public void delete(Oeuvre oeuvre) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de la suppression de l'oeuvre");
            }
        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de la suppression de l'oeuvre ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
