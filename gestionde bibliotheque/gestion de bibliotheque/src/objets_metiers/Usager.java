...
public class Usager {
    ...
    public void ajouter(Usager usager) throws ErrorException {
        ...
        try {
            ...
            if (statut == 0) {
                throw new ErrorException("Erreurs lors de l'ajout d'un usager");
            }

        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de l'ajout d'un usager", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Usager usager) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de la mise à jour de l'usager");
            }
        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de la mise à jour de l'usager ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void delete(Usager usager) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de la suppression de l'usager");
            }
        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de la suppression de l'usager ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
     ...
     */
    public ArrayList<Usager> getListUsagers() throws ErrorException {
     ...
     * @throws ErrorException
     */
    public Usager findById(int id) throws ErrorException {
     ...
     * @throws ErrorException
     */
    public ArrayList<Usager> findByNom(String nom) throws ErrorException {
    ...
    private ArrayList<Usager> find(String sql, Object... objets) throws ErrorException {
        PreparedStatement preparedStatement = null;
