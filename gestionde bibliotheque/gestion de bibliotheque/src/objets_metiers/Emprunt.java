...
public class Emprunt {
    ...
    public void setDateRetourEffective(Date dateRetourEffective) throws ErrorException {
     ...
     * @throws ErrorException Une exception en cas d'erreurs
     */
    public void emprunter(Usager usager, Oeuvre oeuvre, Exemplaire exemplaire, Date dateJour) throws ErrorException {
        Emprunt emprunt = findEmpruntNonRendu(usager, oeuvre);
        if (null != emprunt) {
            throw new ErrorException("Vous avez un emprunt d'exemplaire de cette oeuvre non rendu\n"
        ...
        try {
            ...
            if (statut == 0) {
                throw new ErrorException("Echec lors de l'enregistrement de l'emprunt");
            }
        } catch (SQLException e) {
            throw new ErrorException("Erreurs lors de l'enregistrement de l'emprunt", e.getCause());
    ...
    public void delete(Exemplaire exemplaire) throws ErrorException {
        ...
        try {
            ...
            throw new ErrorException("Erreurs lors de la suppression des emprunts de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
    ...
    public Emprunt findEmpruntNonRendu(Usager usager, Oeuvre oeuvre) throws ErrorException {
    ...
    public ArrayList<Emprunt> findEmprunts(Oeuvre oeuvre) throws ErrorException {
        final String SQL_SELECT_BY_ID_OEUVRE_USAGER = "SELECT emp.*, u.Nom, u.Prenom, o.id, o.Titre, o.Auteur"
                + " FROM emprunt emp, exemplaire e, usager u, oeuvre o"
                + " WHERE emp.ExemplaireId = e.id"
                + " AND emp.UsagerID = u.id"
    ...
    public Emprunt find(Usager usager, int idExemplaire, Oeuvre oeuvre) throws ErrorException {
    ...
    public void Rendre(Emprunt emprunt) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de l'enregistrement du retour de l'exemplaire");
            }
        } catch (SQLException e) {
            throw new ErrorException("Erreurs lors de l'enregistrement du retour de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    private ArrayList<Emprunt> find(String sql, Object... objets) throws ErrorException {
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            throw new ErrorException("Aucun enregistrement trouvé " + e.getMessage());
        } finally {
