...
public class Exemplaire {
    ...
    public void ajouter(Oeuvre oeuvre, String etatExemplaire) throws ErrorException {
        ...
        try {
            ...
            if (statut == 0) {
                throw new ErrorException("Echec d'ajout de l'exemplaire");
            }

        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de l'ajout de l'exemplaire " + e.getMessage(), e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Exemplaire exemplaire) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de la mise à jour de l'exemplaire");
            }
        } catch (SQLException e) {
            throw new ErrorException("Erreurs lors de la mise à jour de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
    ...
    public void delete(Exemplaire exemplaire) throws ErrorException {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new ErrorException("Echec de la suppression de l'exemplaire");
            }
        } catch (SQLException | ErrorException e) {
            throw new ErrorException("Erreurs lors de la suppression de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public ArrayList<Exemplaire> getAll() throws ErrorException {
        final String SQL_SELECT = "SELECT * FROM exemplaire ORDER BY id";
        return find(SQL_SELECT, new Object[0]);
    }

    public Exemplaire findById(int id) throws ErrorException {
     ...
     */
    public ArrayList<Exemplaire> findExemplaireDispo(Oeuvre oeuvre) throws ErrorException {
    ...
    public ArrayList<Exemplaire> find(Oeuvre oeuvre) throws ErrorException {
        final String SQL_SELECT_BY_ID_IDOEUVRE = " SELECT e.*, o.Titre, o.Auteur"
                + " FROM exemplaire e, oeuvre o"
                + " WHERE e.OeuvreID = o.id"
                + " AND e.OeuvreID = ?";
    ...
    public Exemplaire find(Oeuvre oeuvre, int idExemplaire) throws ErrorException {
        final String SQL_SELECT_BY_ID_IDOEUVRE = " SELECT e.*, o.Titre, o.Auteur"
                + " FROM exemplaire e, oeuvre o"
                + " WHERE e.OeuvreID = o.id"
                + " AND e.OeuvreID = ?"
    ...
    private ArrayList<Exemplaire> find(String sql, Object... objets) throws ErrorException {
        PreparedStatement preparedStatement = null;
