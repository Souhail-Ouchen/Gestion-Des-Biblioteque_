...
public class EmpruntControl {
    ...
    public static void emprunter(int id, String titre) throws ErrorException {
        ...
        if(null == exemplaire){
            throw new ErrorException("Aucun exemplaire de l'oeuvre '" 
    ...
    public static void rendre(Emprunt emprunt) throws ErrorException {
        emprunt.Rendre(emprunt);
    }
    
    public static void rendre(String nom, int idOeuvre, int idExemplaire) throws ErrorException {
        Usager usager = new Usager();
        ...
        if (null == exemplaire) {
            throw new ErrorException("L'exemplaire n'existe pas");
        }
        Emprunt emprunt = new Emprunt().find(usager, exemplaire.getId(), oeuvre);
        if (null == exemplaire) {
            throw new ErrorException("L'emprunt n'existe pas");
        }
        emprunt.Rendre(emprunt);
    }
    
    public static ArrayList<Emprunt> findEmprunts(Oeuvre oeuvre) throws ErrorException {
        Emprunt emprunt = new Emprunt();
