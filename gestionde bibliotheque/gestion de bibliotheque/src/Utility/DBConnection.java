...
public class DBConnection {
     ...
     */
    public static Connection getConnection() throws SQLException, ErrorException {
        ...
        if (null == fichierProperties) {
            throw new ErrorException("Le fichier properties '"
        ...
        try {
            ...
            throw new ErrorException("Impossible de charger le fichier properties '"
        ...
        try {
            ...
            throw new ErrorException("Le driver " + PROPERTY_DRIVER.toUpperCase()
                    + " est introuvable\n", e.getCause());
        }
